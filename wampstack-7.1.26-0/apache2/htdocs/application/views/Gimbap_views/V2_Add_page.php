...
<div id="top">
        <div id="top-bar">
            ...
            <table>
                <tr style="vertical-align:top">
                    <td class="top-bar-table"><img style="width:300px; margin-left : 10px; margin-right : 10px; margin-top : 10px;"  src="<?php echo base_url();?>/img/gimbap_images/header_muffin.png"></td>
                    <td style="padding-left:10px"></td>
                    <td class="top-bar-sub-title"><div class="top-bar-sub-title">Playlist 추가</div></td>
                </tr>
            </table>
        </div>
    ...
    <div class='main-blank'></div>
                    ...
                    <script type="text/javascript">
                        ...
                        function ProcessExcel(data, fileName) {
                            ...
                            /* //container[0]에 엑셀파일 정보(파일명, formdata 개수) 입력
                                    ...
                                    fileInfo.append('File_name', fileName);
                                    fileInfo.append('row_length', excelRows.length);
                    
                    
                                    var container = new Array(fileInfo);*/
                            ...
                            for (var i = 0; i < excelRows.length; i++) {
                                ...
                                /* var formdata = new FormData();
                                        ...
                                        formdata.append('data_type', excelRows[i].data_type);
                                        formdata.append('data_eng', excelRows[i].data_eng);
                                        formdata.append('data_kor', excelRows[i].data_kor);
                                        formdata.append('data_mp3', excelRows[i].data_mp3);
                    
                                        container.push(formdata);*/
                        ...
                        function CreateExcelData(data, fileName) {
                            ...
                            //FormData 내용 콘솔 출력 테스트
                            //FormData 참조는 FormData[index].entries();
                            // console.log("===========FormData===========");
                            // for (var pair of container){
        ...
        <div class='main-right-list'>
            <div class="right-top">
                <div>
                    <input class="default_font info_title" id="gimbap_name" placeholder="이름을 입력하시오">
                    <hr class="info_bar">
                </div>
    ...
    <script>
        ...
        $('#save_btn').on('click', function(){
            ...
            if($('#sortable').children().length == 0) // 컨텐츠가 입력이 안되었을때
                ...
                $.ajax({
                    url : "./prohibit_gimbap_name_overlap",
