...
<head>
    ...
    <style>
        ...
        .input{width: 50px; height: 50px; position: relative; left: 610px; margin: 10px; text-align: center; font-size: 30px; display: inline-flex; color:white;}
        ...
        #btn-ing{position:relative; left:48px; }
...
<body>
    ...
    <div class="body">
        ...
        <h4 class="input"><?=$matrix[1][3]?></h4>
        <br><span class="input_space"></span>
        <h4 class="input"><?=$matrix[2][1]?></h4>
        <h4 class="input"><?=$matrix[2][2]?></h4>
        <h4 class="input"><?=$matrix[2][3]?></h4>
        <br><br>
        <h4 class="input"><?=$matrix[3][1]?></h4>
        <h4 class="input"><?=$matrix[3][2]?></h4>
        <h4 class="input"><?=$matrix[3][3]?></h4>
        <br><br>
        <?php } ?>
