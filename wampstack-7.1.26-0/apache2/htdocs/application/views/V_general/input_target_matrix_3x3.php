...
<head>
    ...
    <style>
        ...
        .input{width: 50px; height: 50px; position: relative; left: 560px; margin: 10px; text-align: center; font-size: 30px;}
...
<body>
    ...
    <div class="body">
        ...
        <form action="./get_original_matrix_data" method="post" class="form_position">
            ...
            <input type="text" class="input" name="5">
            <input type="text" class="input" name="6">
            <br><span class="input_space"></span>
            <input type="text" class="input" name="7">
            <input type="text" class="input" name="8">
            <input type="text" class="input" name="9">
            <br><br>
